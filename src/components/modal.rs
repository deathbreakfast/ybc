...
impl Component for Modal {
    ...
    fn create(ctx: &Context<Self>) -> Self {
        ...
        Self {
            _subscription: ModalCloser::bridge(callback),
            is_active: false,
        }
    }
    ...
    fn view(&self, ctx: &Context<Self>) -> Html {
        let ModalProps { children, classes, id, trigger } = ctx.props();
        let mut modal_classes = Classes::from("modal");
        modal_classes.push(classes);
        ...
        html! {
            ...
            <div id={id.clone()} class={modal_classes}>
...
impl Component for ModalCard {
    ...
    fn view(&self, ctx: &Context<Self>) -> Html {
        let ModalCardProps { body, classes, footer, id, title, trigger } = ctx.props();
        let mut modal_classes = Classes::from("modal");
        modal_classes.push(classes);
        let (opencb, closecb) = if self.is_active {
            modal_classes.push("is-active");
