...
impl Component for Dropdown {
    ...
    fn view(&self, ctx: &Context<Self>) -> Html {
        ...
        let mut dropdown_classes = Classes::from("dropdown");
        dropdown_classes.push(classes);
        let opencb = if *hoverable {
            dropdown_classes.push("is-hoverable");
            Callback::noop()
        } else {
        ...
        html! {
            <div class={dropdown_classes}>
                ...
                <div class="dropdown-trigger">
                    <Button classes={button_classes.clone()} onclick={opencb}>
                        {button_html.clone()}
                    </Button>
                </div>
